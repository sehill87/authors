...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.getAuthorsFromService = function () {
        var _this = this;
    ...
    AppComponent.prototype.getAuthorFromService = function (id) {
        var _this = this;
        var observable = this._httpService.getAuthor(id);
        observable.subscribe(function (data) {
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.deleteAuthorFromService = function (id) {
        var _this = this;
...
var EditComponent = /** @class */ (function () {
    ...
    EditComponent.prototype.getAuthorFromServiceById = function () {
        var _this = this;
        this._route.params.subscribe(function (params) {
            console.log(params['id']);
            var observable = _this._httpService.getAuthor(params['id']);
            observable.subscribe(function (data) {
    ...
    EditComponent.prototype.onSubmitEditAuthor = function () {
        var _this = this;
        console.log("this will edit a author");
        var observable = this._httpService.editAuthor(this.editAuthor._id, this.editAuthor);
        observable.subscribe(function (data) {
            if (data['errors']) {
...
var HttpService = /** @class */ (function () {
    ...
    HttpService.prototype.editAuthor = function (id, editauthor) {
...
var NewComponent = /** @class */ (function () {
    ...
    NewComponent.prototype.onSubmitAddAuthor = function () {
        var _this = this;
...
module.exports = __webpack_require__(/*! /Users/scotthill/Desktop/CodingDojo/mean_stack/Angular/Authors/public/src/main.ts */"./src/main.ts");
